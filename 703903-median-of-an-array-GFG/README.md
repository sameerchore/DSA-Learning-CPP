# [Median of an Array](https://www.geeksforgeeks.org/problems/find-the-median0527/1?page=1&company=Amazon)
## Easy
...
Input:&nbsp;arr[] = [1, 2]Output: 1.5Explanation: The average of both elements will result in 1.5.
